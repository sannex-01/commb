    ...
    <div class="flex items-start gap-3">
      ...
      <div class="space-y-1 min-w-0 flex-1">
        ...
        <div class="flex items-center gap-2 pt-2">
          <a href="https://github.com/sannex-01/commb" target="_blank" rel="noreferrer" class="px-2.5 py-1 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-[12px] font-semibold flex items-center gap-1 transition-all">
            ⭐ Star on GitHub
          </a>
  ...
  window.toggleHelpMenu = function(e) {
    ...
    popover.innerHTML = `
      <div class="p-1.5 space-y-0.5 text-[14px]">
        ...
        <a href="https://github.com/sannex-01/commb/discussions" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-muted hover:text-main hover:bg-surface-hover transition-colors">
        ...
        <a href="https://github.com/sannex-01/commb/issues/new?labels=bug-report" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-muted hover:text-main hover:bg-surface-hover transition-colors">
        ...
        <div class="p-5 space-y-4 text-xs text-muted leading-relaxed">
          ...
          <div class="space-y-2.5 p-3.5 rounded-lg bg-surface-elevated/50 border border-subtle text-[12px] font-mono">
            ...
            <div class="flex items-start justify-between gap-3">
              ...
              <a href="https://github.com/sannex-01/commb" target="_blank" rel="noopener noreferrer" class="text-sky-600 dark:text-sky-400 hover:underline break-all text-right font-sans">
                https://github.com/sannex-01/commb
              </a>
            </div>
            <div class="flex items-start justify-between gap-3">
          ...
          <div class="flex items-center justify-between pt-2 border-t border-subtle text-[12px]">
            <a href="https://github.com/sannex-01/commb" target="_blank" rel="noopener noreferrer" class="text-sky-600 dark:text-sky-400 hover:underline flex items-center gap-1 font-semibold">
