...
title: "AICB v0.1.0: Open-Source AI Commerce Bot & Omnichannel Support Platform"
authors: [sannex]
tags: [release, initial, multi-agent, channels, commerce]
date: 2026-09-05
---

We are excited to announce the initial release of **AICB v0.1.0**! AICB is a self-hostable, production-ready AI Commerce Bot and omnichannel customer service platform equipped with Multi-Agent Studio, granular Access Groups, dynamic Messaging Channels (WhatsApp Cloud, Telegram, and Website Widget), real-time Paystack payments, and AgentOS remote telemetry.
